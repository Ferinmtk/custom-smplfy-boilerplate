...
// Fallback for logo if WP functions are not available
...
<div class="ticket">
    ...
    <div class="main">
        <div class="header" style="text-align:center;">
            ...
            <h1><?php echo htmlspecialchars($form_data['event_selection'] ?: 'Event', ENT_QUOTES, 'UTF-8'); ?> Ticket</h1>
        </div>
        ...
        <p><span class="label">Email: </span><?php echo htmlspecialchars($form_data['email'] ?: 'N/A', ENT_QUOTES, 'UTF-8'); ?></p>
        <p><span class="label">Phone: </span><?php echo htmlspecialchars($form_data['phone'] ?: 'N/A', ENT_QUOTES, 'UTF-8'); ?></p>

        <div class="section-title">Event Details</div>
        <p><span class="label">Number of Attendees: </span><?php echo htmlspecialchars($form_data['number_of_attendees'] ?: '0', ENT_QUOTES, 'UTF-8'); ?></p>
        ...
        <p><span class="label">Total Cost: </span><?php echo '$'.number_format($form_data['total_cost'] ?: 0, 2); ?></p>
    </div>

    <!-- Tear-off stub -->
    <div class="stub">
        <h2><?php echo htmlspecialchars($form_data['event_selection'] ?: 'Event', ENT_QUOTES, 'UTF-8'); ?></h2>
        <p><?php echo htmlspecialchars($form_data['name']['first'] ?: '', ENT_QUOTES, 'UTF-8'); ?></p>

        <div class="barcodecell">
            <barcode
                code="<?php echo $site_url . '/?entry=' . $form_data['id']; ?>"
                type="QR"
                class="barcode"
                size="0.8"
                error="M"
